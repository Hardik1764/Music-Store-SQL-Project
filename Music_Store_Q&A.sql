SELECT * FROM music_database.artist;
SHOW Tables;
SELECT * FROM album2;
...
SELECT ar.artist_id, ar.name, COUNT(ar.artist_id) AS Number_Of_Songs FROM track AS t
JOIN album2 AS al ON al.album_id = t.track_id
...
-- below group by clause i use 1,2 insted of (artist.artist_id, artist.name) this
